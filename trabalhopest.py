        ...
        while True:
            ...
            for valor in dados_user:
                ...
                if valor['Senha']== pass_user:
                    ...
                    pass_user = input('Digite a senha do usuário: ')
...
def menu_comprador():
    ...
    p = 1
    while p == 1:
        perg = input("Digite 1 p/ consultar e 2 p/ ir para o menu principal: ")
        ...
        if perg == '1':
            ...
            menu_principal()
            break 
        p = int(input("Deseja continuar digite 1 p/ sim e 2 p/não: "))
        if p == 1:
            menu_comprador()
        elif p == 2:
            menu_principal()
...
def menu_vendedor():
    print('-'*40 )
    print('\nBem vindo ao menu vendedor\n')
    print('-'*40)
    
    p = 1
    while p == 1:
        perg = input("Digite 1 p/ cadastrar um carro e 2 p/ editar: ").strip()
        if len(perg) == 0:
            print("Nada digitado...")
            perg = int(perg)
        elif p == 1:
        ...
        p = int(input("Deseja continuar? Digite 1 p/sim e 2p/não: "))
        if p == 1:
            menu_vendedor()
        elif p == 2:
            print('Tudo bem!!!')
...
def cadastrar_carro():
    ...
    while p == 1:
        ...
        if pergunta == 2:
            mod_carro = input('Digite o nome do carro: ').strip()#inputtexto tudo que tiver esse strip
            ...
            marca_carro =input('Qual a marca do carro: ').strip()
           
            if marca_carro in carros:
                print('Esse marca já está cadastrada...')
